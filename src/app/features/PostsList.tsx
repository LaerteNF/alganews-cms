...
export default function PostList () {
  ...
  const [page, setPage] = useState(paginatedPosts?.page);
  ...
  const columns = useMemo<Column<Post.Summary>[]>(
    () => [
      ...
      {
        Header: () => <div style={{ textAlign: 'left' }}>Última atualização</div>,
        accessor: 'updatedAt',
        Cell: (props) => <div 
          style={{ 
            display: 'flex', 
  ...
  const instance = useTable<Post.Summary>(
    { 
      ...
      initialState: { pageIndex: paginatedPosts?.page },
  ...
  return <>
    ...
    <Table 
      instance={instance}
      onPaginate={(index) => {setPage(index)}}
    />
  </>
